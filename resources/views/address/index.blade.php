                        ...
                        <div class="mt-8 overflow-x-auto">
                            <div class="inline-block min-w-full py-2 align-middle">
                                <table class="w-full divide-y divide-gray-300">
									...
									<th scope="col" class="py-3 pl-4 pr-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">Street Address</th>
									<th scope="col" class="py-3 pl-4 pr-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">Latitude</th>
									<th scope="col" class="py-3 pl-4 pr-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">Longitude</th>
                                    ...
                                    @foreach ($addresses as $address)
										...
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $address->municipality_id }}</td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $address->street_address }}</td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $address->latitude }}</td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $address->longitude }}</td>
